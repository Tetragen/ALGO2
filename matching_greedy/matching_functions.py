...
def show_matching(edge, nodes,dot, index, matching_length, dir_name):
...
def match_graph(edges_list, nodes, dot, dir_name):
    """
    ...
    for edge in edges_list:
        ...
        if edge[0] in matched_nodes:
            ...
            show_matching(edge,nodes, dot, index, matching_length, dir_name)
